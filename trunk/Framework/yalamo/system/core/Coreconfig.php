...
define("YCOREFUNCFILE",YPATH."system".DS."core".DS."Corefunc".EXT );
 ...
 */
$YAUTOLOADCINFIG = array (
    "MODULES"       =>$BASECONFIG["AUTOLOAD"]["MODULES"],
    "HELPERS"       =>$BASECONFIG["AUTOLOAD"]["HELPERS"],
    "EXTENSIONS"    =>$BASECONFIG["AUTOLOAD"]["EXTENSIONS"]
);
